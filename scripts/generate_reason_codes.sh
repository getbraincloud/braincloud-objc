#!/usr/bin/env bash
# generate_reason_codes.sh
# Auto-generate ReasonCodes.hh and ReasonCodes.m
# Usage: ./generate_reason_codes.sh <path_to_cpp_dir> <output_dir>
...
usage() {
  ...
  echo ""
  echo "Example:"
  echo "  ./generate_reason_codes.sh ../cpp ../objc"
  echo ""
  echo "This will look for:"
  echo "  ../cpp/include/braincloud/reason_codes.h"
  echo "and generate:"
  echo "  ../objc/Shared/ReasonCodes.hh"
  echo "  ../objc/Shared/ReasonCodes.m"
  exit 1
}
...
SRC_HEADER="$SRC_DIR/include/braincloud/reason_codes.h"
OUT_HEADER="$OUT_DIR/ReasonCodes.hh"
OUT_IMPL="$OUT_DIR/ReasonCodes.m"
