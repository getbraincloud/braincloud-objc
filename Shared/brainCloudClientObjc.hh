...
//! Project version string for brainCloudClientObjc.
//FOUNDATION_EXPORT const unsigned char brainCloudClientObjcVersionString[];

// In this header, you should import all the public headers of your framework
// using statements like #import <brainCloudClientObjc/PublicHeader.h>
