...
NSString const *const BrainCloudServiceOperationGetGlobalLeaderboardPageIfExists = [NSString stringWithCString:BrainCloud::ServiceOperation::GetGlobalLeaderboardPageIfExists.getValue().c_str() encoding:NSASCIIStringEncoding];
...
NSString const *const BrainCloudServiceOperationGetGlobalLeaderboardViewIfExists = [NSString stringWithCString:BrainCloud::ServiceOperation::GetGlobalLeaderboardViewIfExists.getValue().c_str() encoding:NSASCIIStringEncoding];
